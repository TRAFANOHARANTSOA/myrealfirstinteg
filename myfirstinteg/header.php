...
<html lang="fr" dir="ltr">
  ...
  <body class="bg-white">
      ...
      <header>
                          ...
                          <nav class="container navbar navbar-expand-md navbar-dark bg-dark ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                              <ul class="navbar-nav text-uppercase w-100 align-items-center ">
                                <li class="nav-item ">
                                  <a class="nav-link"  href="#accueil"> Accueil </a>
                                </li>
                                <li class="nav-item ">
                                  <a class="nav-link" href="#menu2"> Portfolio </a>
                                </li>
                                <li class="nav-item ">
                                  <a class="nav-link" href="#menu1"><img src="logo/thlogopaint.png" class="img-fluid" title="Tsiry RAFANOHARANTSOA" h-75/></a>
                                </li>
                                <li class="nav-item ">
                                  <a class="nav-link" href="#menu4">Contact</a>
                                </li>
                                <li class="nav-item ">
                                  <a class="nav-link" href="#menu3">Curriculum vitae</a>
                                </li>
                              </ul>
                            </div>
                          </nav>
                    ...
                    <div id="carousel" class="carousel slide" data-interval="2000" data-ride="carousel" >
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active carouselimg ">
                            <img src="../images/jeffersonsantos.jpg" class="d-block img-fluid"  alt="jeffersonsantos">
                          ...
                          <div class="carousel-item carouselimg">
                            <img src="../images/mariusniveri.jpg" class="d-block img-fluid" alt="mariusniveri">
                              <div class="carousel-caption d-none d-md-block">
                                <h5>Photo 2</h5>
                                <p>Description</p>
                              </div>
                          ...
                          <div class="carousel-item carouselimg">
                            <img src="../images/fondwebdesign.jpg" class="d-block img-fluid" alt="fondwebdesign">
                              <div class="carousel-caption d-none d-md-block">
                                <h5>Photo 3</h5>
                                <p>Description</p>
                              </div>
      ...
      <section id="menu1" >
                    <div class="container bg-light pt-2 mb-4 shadow shadow-md  sectioncontainer ">
                      <div class="page-header text-center  ">
                        <h1>MENU 1</h1>
                        <p >Ambitioni dedisse scripsisse iudicaretur.</p>
                        <hr class="rupture">
                      ...
                      <div class="row justify-content-around ">
                        <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
                          ...
                          <h3 class="texte-center"> SOUSTITRE1 </h3>
                          <hr class="rupture">
                          <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
                          <a class="tv" href="#"> <img src="../images/tv.jpg" class="img-fluid d-block mx-auto " alt="télé"> </a>
                          <h2 class="texte-center"> TITRE2 </h2>
                          <h3 class="texte-center"> SOUSTITRE2 </h3>
                          <hr class="rupture">
                          <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                        <div class=" col-sm-12 col-md-6 col-lg-2 col-xl-2">
                          <a class="clothes" href="#"> <img src="../images/clothes.jpg" class="img-fluid d-block mx-auto" alt="clothes"> </a>
                          <h2 class="texte-center"> TITRE3 </h2>
                          <h3 class="texte-center"> SOUSTITRE3 </h3>
                          <hr class="rupture">
                          <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                        <div class=" col-sm-12 col-md-6 col-lg-2 col-xl-2">
                          <a class="disk" href="#"> <img src="../images/disk.jpg" class="img-fluid d-block mx-auto" alt="disk"> </a>
                          <h2 class="texte-center"> TITRE4 </h2>
                          <h3 class="texte-center"> SOUSTITRE4 </h3>
                          <hr class="rupture">
                          <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                      </div>
    ...
    <section id="carouselresponsive1">
                  <div class="container bg-light shadow shadow-md pt-2 pb-4 ">
                    <div class="page-header text-center  ">
                      <h1>MENU 1</h1>
                      <p >Ambitioni dedisse scripsisse iudicaretur.</p>
                    ...
                    <div id="carouselresponsivecarousel" class="carousel slide" data-interval="4000" data-ride="carousel" >
                        <div class="carousel-inner">
                          ...
                          <a class="carousel-control-prev" href="#carouselresponsivecarousel" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon " aria-hidden="true"></span>
                            <span class="sr-only ">Previous</span>
                          </a>
                          <a class="carousel-control-next" href="#carouselresponsivecarousel" role="button" data-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="sr-only">Next</span>
                          </a>
                        </div>
      ...
      <section id="menu2">
                    <div class="container bg-light shadow shadow-md  pt-2">
                        <div class="page-header text-center ">
                          <h1>MENU 2</h1>
                          <p>Ambitioni dedisse scripsisse iudicaretur.</p>
                          <hr class="rupture">
                          ...
                          <div class="row justify-content-around mt-5 ">
                            <div class="col-md-5 col-lg-2 pt-1 mt-5 bg-white shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/zach.jpg">
                            ...
                            <div class="col-md-5  col-lg-2 pt-1 mt-5 bg-white  shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/zach.jpg">
                                  <img src="../images/zach.jpg" alt="route" class="img-fluid " style="width:100%">
                                  <i class="fas fa-camera-retro position-relative"></i>
                                </a>
                                <div class="caption">
                                  <p class="text-uppercase text-center ">Lorem ipsum...</p>
                                </div>
                            ...
                            <div class="col-md-5  col-lg-2  pt-1 mt-5 bg-white  shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/jakob.jpg">
                                  <img src="../images/zach.jpg" alt="route" class="img-fluid " style="width:100%">
                                  <i class="fas fa-play-circle position-relative"></i>
                                </a>
                                <div class="caption">
                                  <p class="text-uppercase text-center ">Lorem ipsum...</p>
                                </div>
                            ...
                            <div class="col-md-5 col-lg-2 pt-1 mt-5 bg-white  shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/jakob.jpg">
                                  <img src="../images/zach.jpg" alt="route" class="img-fluid " style="width:100%">
                                  <i class="fas fa-tablet-alt position-relative"></i>
                                </a>
                                <div class="caption">
                                  <p class="text-uppercase text-center position-relative">Lorem ipsum...</p>
                                </div>
                              <!--<div class="iconequibougeaupointeur"> </div< -->
                              </div>
                            </div>
                          ...
                          <div class="row justify-content-around mb-5  ">
                            ...
                            <div class="col-md-5  col-lg-2  pt-1  mt-5 bg-white  shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/zach.jpg">
                                  <img src="../images/zach.jpg" alt="route" class="img-fluid" style="width:100%">
                                  <i class="fas fa-gamepad position-relative"></i>
                                </a>
                                <div class="caption">
                                  <p class="text-uppercase text-center position-relative">Lorem ipsum...</p>
                                </div>
                            ...
                            <div class="col-md-5  col-lg-2  pt-1  mt-5 bg-white  shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/jakob.jpg">
                                  <img src="../images/zach.jpg" alt="route" class="img-fluid " style="width:100%">
                                  <i class="fas fa-compact-disc position-relative"></i>
                                </a>
                                <div class="caption">
                                  <p class="text-uppercase text-center ">Lorem ipsum...</p>
                                </div>
                            ...
                            <div class="col-md-5  col-lg-2  pt-1 mt-5 bg-white  shadow-sm">
                              <div class="thumbnail position-relative">
                                <a href="../images/jakob.jpg">
                                  <img src="../images/zach.jpg" alt="route" class="img-fluid " style="width:100%">
                                  <i class="fas fa-desktop position-relative"></i>
                                </a>
                          ...
                          <div class="textpresentationcontainer2">
                              <a class="nav-link text-center links" href="#"> LIEN POUR TOUT VOIR </a>
                          </div>
                      </div>
      </section>
                    ...
                    <div class="container bg-light shadow shadow-md pt-2 pb-4 ">
                      ...
                      <div id="carouselmenu2" class="carousel slide" data-interval="3000" data-ride="carousel" >
                          <div class="carousel-inner">
                              <div class="carousel-item active ">
                                <div class="col bg-white shadow-sm">
                                  <div class="thumbnail d-block position-relative">
                                    <a href="../images/zach.jpg">
                                      <img src="../images/zach.jpg" alt="route" class="img-fluid d-block" style="width:100%">
                                      <i class="fas fa-film position-relative"></i>
                                    </a>
                            ...
                            <a class="carousel-control-next" href="#carouselmenu2" role="button" data-slide="next">
                              <span class="carousel-control-next-icon" aria-hidden="true"></span>
                              <span class="sr-only">Next</span>
                            </a>
                        </div>
